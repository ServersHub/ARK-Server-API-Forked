...
struct UGameplayStatics
{
	...
	static void LoadStreamLevel(UObject* WorldContextObject, FVector Top, FVector Bottom, float Radius, FLinearColor Color, float LifeTime, bool bPersistent) { NativeCall<void, UObject*, FVector, FVector, float, FLinearColor, float, bool>(nullptr, "UGameplayStatics.LoadStreamLevel", WorldContextObject, Top, Bottom, Radius, Color, LifeTime, bPersistent); }
...
struct UKismetSystemLibrary
{
	...
	static void DrawDebugFrustum(UObject* WorldContextObject, FTransform* FrustumTransform, FLinearColor FrustumColor, float Duration, bool bPersistent) { NativeCall<void, UObject*, FTransform*, FLinearColor, float, bool>(nullptr, "UKismetSystemLibrary.DrawDebugFrustum", WorldContextObject, FrustumTransform, FrustumColor, Duration, bPersistent); }
	static void DrawDebugFloatHistoryLocation(UObject* WorldContextObject, FDebugFloatHistory* FloatHistory, FVector DrawLocation, FVector2D DrawSize, FLinearColor DrawColor, float LifeTime, bool bPersistent) { NativeCall<void, UObject*, FDebugFloatHistory*, FVector, FVector2D, FLinearColor, float, bool>(nullptr, "UKismetSystemLibrary.DrawDebugFloatHistoryLocation", WorldContextObject, FloatHistory, DrawLocation, DrawSize, DrawColor, LifeTime, bPersistent); }
...
struct UVictoryCore
{
	...
	static bool VTraceSingleBP(UWorld* theWorld, FHitResult* OutHit, FVector* Start, FVector* End, ECollisionChannel TraceChannel, int CollisionGroups, FName TraceTag, bool bTraceComplex, AActor* ActorToIgnore, float DebugDrawDuration) { return NativeCall<bool, UWorld*, FHitResult*, FVector*, FVector*, ECollisionChannel, int, FName, bool, AActor*, float>(nullptr, "UVictoryCore.VTraceSingleBP", theWorld, OutHit, Start, End, TraceChannel, CollisionGroups, TraceTag, bTraceComplex, ActorToIgnore, DebugDrawDuration); }
	static bool VTraceSingleBP_IgnoreActorsArray(UWorld* theWorld, FHitResult* OutHit, FVector* Start, FVector* End, TArray<AActor*>* ExtraIgnoreActors, AActor* InIgnoreActor, ECollisionChannel TraceChannel, int CollisionGroups, FName TraceTag, bool bReturnPhysMaterial, bool bTraceComplex, float DebugDrawDuration) { return NativeCall<bool, UWorld*, FHitResult*, FVector*, FVector*, TArray<AActor*>*, AActor*, ECollisionChannel, int, FName, bool, bool, float>(nullptr, "UVictoryCore.VTraceSingleBP_IgnoreActorsArray", theWorld, OutHit, Start, End, ExtraIgnoreActors, InIgnoreActor, TraceChannel, CollisionGroups, TraceTag, bReturnPhysMaterial, bTraceComplex, DebugDrawDuration); }
	static bool VTraceSphereBP(UWorld* theWorld, FVector* Start, FVector* End, FHitResult* HitOut, float Radius, AActor* ActorToIgnore, ECollisionChannel Channel, int CollisionGroups, bool bReturnPhysMaterial, bool bTraceComplex, FName TraceTag, AActor* OtherActorToIgnore, AActor* AnotherActorToIgnore, float DebugDrawDuration) { return NativeCall<bool, UWorld*, FVector*, FVector*, FHitResult*, float, AActor*, ECollisionChannel, int, bool, bool, FName, AActor*, AActor*, float>(nullptr, "UVictoryCore.VTraceSphereBP", theWorld, Start, End, HitOut, Radius, ActorToIgnore, Channel, CollisionGroups, bReturnPhysMaterial, bTraceComplex, TraceTag, OtherActorToIgnore, AnotherActorToIgnore, DebugDrawDuration); }

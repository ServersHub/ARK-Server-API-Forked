...
struct UPrimalInventoryComponent : UActorComponent
{
	...
	UPrimalItem* AddItem(FItemNetInfo* theItemInfo, bool bEquipItem, bool bAddToSlot, bool bDontStack, FItemNetID* InventoryInsertAfterItemID, bool bShowHUDNotification, bool bDontRecalcSpoilingTime, bool bForceIncompleteStacking, AShooterCharacter* OwnerPlayer, bool bIgnoreAbsoluteMaxInventory, bool bInsertAtItemIDIndexInstead, bool doVersionCheck) { return NativeCall<UPrimalItem*, FItemNetInfo*, bool, bool, bool, FItemNetID*, bool, bool, bool, AShooterCharacter*, bool, bool, bool>(this, "UPrimalInventoryComponent.AddItem", theItemInfo, bEquipItem, bAddToSlot, bDontStack, InventoryInsertAfterItemID, bShowHUDNotification, bDontRecalcSpoilingTime, bForceIncompleteStacking, OwnerPlayer, bIgnoreAbsoluteMaxInventory, bInsertAtItemIDIndexInstead, doVersionCheck); }
	...
	APrimalStructureItemContainer* BPDropForceLocationInventoryDeposit(long double DestroyAtTime, int OverrideMaxItemsDropped, FVector CacheLocationOverride, int DeadPlayerID) { return NativeCall<APrimalStructureItemContainer*, long double, int, FVector, int>(this, "UPrimalInventoryComponent.BPDropForceLocationInventoryDeposit", DestroyAtTime, OverrideMaxItemsDropped, CacheLocationOverride, DeadPlayerID); }
...
struct UPrimalItem : UObject
{
	...
	static UPrimalItem* AddNewItem(TSubclassOf<UPrimalItem> ItemArchetype, UPrimalInventoryComponent* GiveToInventory, bool bEquipItem, bool bDontStack, float ItemQuality, bool bForceNoBlueprint, int quantityOverride, bool bForceBlueprint, float MaxItemDifficultyClamp, bool CreateOnClient, TSubclassOf<UPrimalItem> ApplyItemSkin, float MinRandomQuality, bool clampStats, bool bIgnoreAbsoluteMaxInventory) { return NativeCall<UPrimalItem*, TSubclassOf<UPrimalItem>, UPrimalInventoryComponent*, bool, bool, float, bool, int, bool, float, bool, TSubclassOf<UPrimalItem>, float, bool, bool>(nullptr, "UPrimalItem.AddNewItem", ItemArchetype, GiveToInventory, bEquipItem, bDontStack, ItemQuality, bForceNoBlueprint, quantityOverride, bForceBlueprint, MaxItemDifficultyClamp, CreateOnClient, ApplyItemSkin, MinRandomQuality, clampStats, bIgnoreAbsoluteMaxInventory); }
